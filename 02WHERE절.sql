...
--IS NULL, IS NOT NULL
SELECT * FROM EMPLOYEES WHERE COMMISSION_PCT = NULL; -- 잘못됨
...
SELECT * FROM EMPLOYEES WHERE JOB_ID = 'IT_PROG' AND SALARY >= 6000; --AND =둘다 만족하면 OK
SELECT * FROM EMPLOYEES WHERE JOB_ID = 'IT_PROG' OR SALARY >= 6000;--OR = 하나라도 만족하면 OK
...
----------------------------------------------------------------------------------------------------
--ORDER BY절 컬럼(엘리어스)
SELECT * FROM EMPLOYEES ORDER BY HIRE_DATE; --날짜기준 ASC
SELECT * FROM EMPLOYEES ORDER BY HIRE_DATE DESC; 

SELECT * FROM EMPLOYEES WHERE JOB_ID IN ('IT PROG' , 'ST_MAN') ORDER BY FIRST_NAME DESC;
SELECT * FROM EMPLOYEES WHERE SALARY BETWEEN 6000 AND 12000 ORDER BY EMPLOYEE_ID;

--ALIAS도 ORDER절에 사용할 수 있습니다.
